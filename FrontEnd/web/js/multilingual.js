...
const lang = {
  en: {
    ...
    description2:
      "You can use simple URLs for link sharing or text transmission.",
    description3: "If you use this for malicious purposes, it can be deleted.",
    description4:
      "It can be restricted if daily allowed traffic is exceeded. If you have a lot of usage, please contact us by email.",
    description5:
      "If you need a custom domain(designated URL), please contact us by email.",
  ...
  ko: {
    ...
    description4:
      "일일 허용 트래픽 초과시 주소 변환이 제한될 수 있습니다. (일일 사용량이 많을 경우 이메일 문의 바랍니다.)",
